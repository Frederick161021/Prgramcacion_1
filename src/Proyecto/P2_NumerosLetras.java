...
public class P2_NumerosLetras extends javax.swing.JFrame {
    static P2Proyecto P2 = new P2Proyecto();
    
    public P2_NumerosLetras() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(JButtonLImpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 60, 80, -1));
        ...
        getContentPane().add(jLabelLimpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 140, -1, -1));
        ...
        jLabelResultado.setText("EL numero es:");
        ...
        jLabelIndicaciones.setText("Digita un numero entero del 0 al 100");
        getContentPane().add(jLabelIndicaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 30, -1, -1));

        jLabelNumero.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabelNumero.setForeground(new java.awt.Color(0, 0, 0));
        jLabelNumero.setText("Numero:");
        getContentPane().add(jLabelNumero, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, -1, -1));

        jTextNumero.setBackground(new java.awt.Color(153, 255, 255));
        jTextNumero.setForeground(new java.awt.Color(0, 0, 0));
        getContentPane().add(jTextNumero, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, 120, -1));
    ...
    private void jButtonInicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInicoActionPerformed
        int cantidad = Integer.parseInt(jTextNumero.getText());
        String salida="";
        salida = P2.Calculo(cantidad);
        JTA.setText(salida);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P2_NumerosLetras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new P2_NumerosLetras().setVisible(true);
            }
        });
    }
