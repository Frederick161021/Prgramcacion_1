...
public class P1_CalculoDias extends javax.swing.JFrame {

    static P1Proyecto P1 = new P1Proyecto();
    
    public P1_CalculoDias() {
        initComponents();
    ...
    private void jButtonInicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInicoActionPerformed
        ...
        salida+="Desde la fecha del:  "+diaNacio+" / "+mN+" / "+añoNacio+
                " a la fecha actual del: "+diaActual+" / "+mA+" / "+añoActual+" es de: ";
        salida+= P1.calculoDias(diaNacio,mesNacio,añoNacio,diaActual,mesActual,añoActual);
        JTA.setText(salida);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P1_CalculoDias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new P1_CalculoDias().setVisible(true);
            }
        });
    }
